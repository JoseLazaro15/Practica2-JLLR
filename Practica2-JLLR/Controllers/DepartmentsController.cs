...
namespace Practica2_JLLR.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(Practica2BdContext context)
        {
            _context = context;
        }
        ...
        {
            var practica2BdContext = _context.Departments.Include(d => d.Instructor);
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,Name,Budget,StartDate,InstructorID")] Department department)
        {
            ...
            ViewData["InstructorID"] = new SelectList(_context.Instructors, "InstructorID", "InstructorID", department.InstructorID);
            return View(department);
        }
